...
program : MultitierProgram (Model Main.Model Main.Msg Main.ServerModel Main.ServerMsg) (ServerModel Main.ServerModel Main.ServerMsg Main.Model Main.Msg) (Msg Main.Msg) (ServerMsg Main.ServerMsg)
program =
  Debugger.program
    { config = Main.config
    , init = Main.init
